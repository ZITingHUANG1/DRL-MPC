...
def myplot(xground, yground):
    ...
    ax.plot([0, 200], [-10, -10], '-b', linewidth=1.2)
    ellipse1 = Ellipse(xy=(50, 0), width=20, height=10, edgecolor='r', fc='red')
...
def main():
    ...
    for i in range(200):
        ...
        if tempactlistax!=[]:
            actionlistax.append(tempactlistax)
        if tempactlistdelta != []:
            actionlistdelta.append(tempactlistdelta)
